...
function Sidebar({
  side = "right", // Changed default to "right" for RTL/Farsi
  variant = "sidebar",
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}
    >
      {/* Rotated icon for RTL context if sidebar is on right */}
      <TextAlignJustify className="rtl:rotate-180" />
  ...
  return (
    <main
      ...
      className={cn(
        ...
        // Converted margins to logical properties (ms = margin-start)
...
function SidebarGroupAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        // Converted right/top to logical/RTL friendly where possible or kept absolute
...
const sidebarMenuButtonVariants = cva(
  // Converted text-left to text-start, pr-8 to pe-8
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      className={cn(
        // Converted border-l (left) to border-s (start/right in RTL)
        // Converted translate-x-px to logical equivalent if needed, but keeping simple
